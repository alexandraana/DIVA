...
sc.pp.neighbors(andata,use_rep='X')
...
bbknn.bbknn(andata,batch_key='Batch')
...
scIB.me.lisi_graph(andata,batch_key='Batch',label_key='Group')

scIB.me.kBET(andata,batch_key='Batch',label_key='Group')

scIB.me.graph_connectivity(andata,label_key='Group')
